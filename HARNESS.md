...
Ccによるプロジェクト別DDD・テスト受入条件、フック観測、LLM不要のオンタイムテストは
[`FORMAT_CC_HARNESS.md`](./FORMAT_CC_HARNESS.md) を参照する。設定と実際の適用・検証結果は分けて扱う。
...
- **コアドメインの UX を先に読む。** `spec/ux/product.md` と `spec/ux/<domain>.md`
  ([`FORMAT_UX.md`](./FORMAT_UX.md)) の問題・価値・制約を起点に、ドメインと検証を計画する。
